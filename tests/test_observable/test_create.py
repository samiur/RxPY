...
from rx3.disposable import BooleanDisposable
...
class TestCreate(unittest.TestCase):
    ...
    def test_create_exception(self):
        with self.assertRaises(RxException):
            rx3.create(lambda o, s: _raise('ex')).subscribe()
    ...
    def test_create_observer_throws(self):
        ...
        with self.assertRaises(RxException):
            rx3.create(subscribe).subscribe(lambda x: _raise('ex'))
        ...
        with self.assertRaises(RxException):
            rx3.create(subscribe2).subscribe(on_error=lambda ex: _raise('ex'))
        ...
        with self.assertRaises(RxException):
            rx3.create(subscribe3).subscribe(on_completed=lambda: _raise('ex'))
