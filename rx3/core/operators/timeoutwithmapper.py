...
def _timeout_with_mapper(first_timeout: Optional[Observable] = None,
    ...
    observable sequence if a timeout is signaled.
        ...
        res = timeout_with_mapper(rx3.timer(500))
        res = timeout_with_mapper(rx3.timer(500), lambda x: rx3.timer(200))
        res = timeout_with_mapper(rx3.timer(500), lambda x: rx3.timer(200)), rx3.return_value(42))
    ...
    Args:
        ...
        other -- [Optional] Sequence to return in case of a timeout. If not
            provided, this is set to rx3.throw().
